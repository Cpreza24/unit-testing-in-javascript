...
const unitTestExampleTwo = () => {
    ...
    console.log(
        'Test 2: Adding two non-numeric strings ("Hello " and "world")'
    );
    console.log(add('Hello ', 'world') === 'Hello world' ? 'Passed' : 'Failed');
};

const unitTestExampleThree = () => {
    //writes a test that handles two different input types
    console.log('Test 3: adding number and a string');
